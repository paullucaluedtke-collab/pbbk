...
import { LayoutDashboard, FilePlus, FileText, ArrowLeft, Calculator } from 'lucide-react';

export default function SteuerLayout({ children }: { children: React.ReactNode }) {
    const pathname = usePathname();

    const navItems = [
        { href: '/steuer', label: 'Übersicht', icon: LayoutDashboard, exact: true },
        { href: '/steuer/neu', label: 'Neue Erklärung', icon: FilePlus },
    ];
