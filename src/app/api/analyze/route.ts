...
export async function POST(req: NextRequest) {
    ...
    - category (One of: "Büromat./Porto/Tel.", "Fortbildung", "KFZ-Kosten", "Miete/Nebenkosten", "Reisekosten", "Bewirtung", "Wareneingang", "Fremdleistung", "Geldtransit", "Privatentnahme", "Sonstiges")
